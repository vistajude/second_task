...
$api_url = "http://localhost/vista-rest-api/api/test_api.php?action=fetch_all";
...
if(count($result) > 0)
{
	foreach($result as $row)
	{
		...
		<tr>
			...
			<td>'.$row->last_name.'</td>
			<td><button type="button" name="edit" class="btn btn-success btn-xs edit" id="'.$row->id.'" style="width:100%">Edit</button></td>
